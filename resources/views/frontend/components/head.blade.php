...
<head>
    ...
    <link rel="apple-touch-icon-precomposed" type="image/x-icon" href="{{ asset('assets/img/apple-icon-72x72.png') }}"
        sizes="72x72">
    <link rel="apple-touch-icon-precomposed" type="image/x-icon"
        href="{{ asset('assets/img/apple-icon-114x114.png') }}" sizes="114x114">
    <link rel="apple-touch-icon-precomposed" type="image/x-icon"
